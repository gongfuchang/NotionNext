...
const BLOG = {
  ...
  NOTION_PAGE_ID:
        process.env.NOTION_PAGE_ID || 'f9553e9fa83443f784443e5d8819b2e7',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Quick Mind', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Quick Mind', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://quick-mind.cn', // 网站地址
  DOCS: process.env.NEXT_PUBLIC_DOCS || 'http://docs.quick-mind.cn', // 网站地址

  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Quick Mind, RAG, LLM, AIGC, Knowledge Center, Enterprise Search', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'gfc@dandantech.top', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/gongfuchang', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon-qm.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
